...
const Dealers = () => {
  ...
  const generateDealerId = (firmName) => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    const dealerId = generateDealerId(formData.firmName);
  ...
  const totalReceivables = dealers.reduce(
    (sum, dealer) => sum + dealer.receivables,
    0,
  );
  ...
  const avgRating =
    dealers.reduce((sum, dealer) => sum + dealer.rating, 0) / dealers.length;
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-white/90 backdrop-blur-sm p-6 rounded-3xl shadow-xl border border-white/50 hover:shadow-2xl transition-all duration-300">
          ...
          <p className="text-xs text-yellow-600 mt-2">Network performance</p>
        </div>
      </div>
      ...
      <div className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-xl border border-white/50 p-6 mb-8">
        <div className="flex flex-col lg:flex-row gap-4 items-center">
          ...
          <div className="flex-1 relative">
            ...
            <input
              type="text"
              placeholder="Search dealers by name, firm, region, or contact..."
          ...
          <div className="flex gap-3">
            ...
            >
              ...
              <option value="high-receivables">High Receivables</option>
              ...
              <div className="relative z-10 flex items-start justify-between">
                <div className="flex items-center gap-4">
                  <img
                    ...
                    className="w-16 h-16 rounded-2xl border-3 border-white shadow-xl"
                  />
                  <div>
                    <h3 className="text-2xl font-bold">{dealer.firmName}</h3>
                    <p className="text-blue-100 text-lg">{dealer.dealerName}</p>
                ...
                <div className="text-right">
                  <span
                    className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium ${getStatusColor(dealer.receivables)}`}
                  >
                    {dealer.receivables === 0
                      ? "✅ Clear"
                      : dealer.receivables > 50000
                        ? "⚠️ High Due"
                        : "💰 Pending"}
                  </span>
                </div>
            ...
            <div className="p-6">
              ...
              <div className="grid grid-cols-3 gap-4 mb-6">
                ...
                <div className="text-center p-4 bg-purple-50 rounded-2xl border border-purple-200">
                  ...
                  <p className="text-xs text-purple-500 font-medium">Region</p>
                </div>
              </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-3xl font-bold text-red-600">
                        ₹{dealer.receivables.toLocaleString()}
                      </p>
                    </div>
              ...
              <div className="flex items-center justify-between text-sm text-gray-500 mb-6">
                <div className="flex items-center gap-2">
                  ...
                  <span>Joined: {dealer.joinDate}</span>
                </div>
                <div className="flex items-center gap-2">
                  <Building className="w-4 h-4" />
                  <span>Last Order: {dealer.lastOrder}</span>
                </div>
              </div>

              {/* Action Buttons */}
              <div className="flex gap-3">
                <button className="flex-1 bg-gradient-to-r from-blue-500 to-blue-600 text-white py-3 px-4 rounded-2xl hover:from-blue-600 hover:to-blue-700 transition-colors shadow-lg transform hover:scale-105 text-lg font-semibold flex items-center justify-center gap-2">
              ...
              {formData.firmName && (
                <div className="bg-cyan-50 p-6 rounded-2xl border border-cyan-200">
                  ...
                  <div className="text-2xl font-bold text-cyan-600 font-mono">
                    {generateDealerId(formData.firmName)}
                  </div>
                </div>
              )}
